...
pub struct Commitment {
    ...
    pub extra_data: Map<String, Val>,   // تم تغيير النوع من Map<String, String> إلى Map<String, Val>
    pub created_at: u64,
...
impl MithaqContract {
    ...
    pub fn confirm_delivery(env: Env, id: u64, counterparty: Address, biometric_hash: String) {
        ...
        // تخزين hash كـ Val (نوع String محفوظ داخل Val)
        c.extra_data.set(String::from_str(&env, "delivery_proof_hash"), biometric_hash.into_val());
    ...
    pub fn release_milestone(env: Env, id: u64, caller: Address, milestone: u32) {
        ...
        // قراءة milestone السابقة كـ Val ثم تحويلها إلى u32
        let current_milestone: u32 = c.extra_data
            .get(String::from_str(&env, "milestone"))
            .unwrap_or(Val::from_u32(0))
            .try_into_val(&env)
            .unwrap_or(0u32);

        if milestone <= current_milestone { panic!("Double spending/release attempt"); }

        // تخزين milestone الجديد كـ Val (u32)
        c.extra_data.set(String::from_str(&env, "milestone"), Val::from_u32(milestone));
    ...
    pub fn pay_installment(env: Env, id: u64, caller: Address, installment_num: u32) {
        ...
        c.extra_data.set(String::from_str(&env, "installment"), Val::from_u32(installment_num));
