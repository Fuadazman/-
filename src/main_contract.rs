...
impl MithaqContract {
    ...
    pub fn release_milestone(env: Env, id: u64, caller: Address, milestone: u32) {
        ...
        // --- التعديل هنا لتحويل النوع بين String و u32 ---
        ...
        let milestone_str = String::from_str(&env, &milestone.to_string());
        c.extra_data.set(String::from_str(&env, "milestone"), milestone_str);
        // --- نهاية التعديل ---
    ...
    pub fn pay_installment(env: Env, id: u64, caller: Address, installment_num: u32) {
        ...
        // --- نفس تحويل النوع للتوافق مع extra_data: Map<String, String> ---
        ...
        let installment_str = String::from_str(&env, &installment_num.to_string());
        c.extra_data.set(String::from_str(&env, "installment"), installment_str);
        // --- نهاية التعديل ---
