...
// ===== الثوابت الاقتصادية ومعايير الشبكة =====
const DECIMALS: u32 = 7;
const DECIMAL_FACTOR: i128 = 10_000_000; // 10^7
const BPS_DENOMINATOR: i128 = 10000; // نقاط اساس: 100 = 1%

const PROPOSAL_PENALTY_AMOUNT: i128 = 10 * DECIMAL_FACTOR; // 10 AZM
const DEVELOPER_SHARE: i128 = 5 * DECIMAL_FACTOR; // 5 AZM
const SAFETY_FUND_SHARE: i128 = 5 * DECIMAL_FACTOR; // 5 AZM

// نسب الرسوم الافتراضية (100 = 1%)
const DEFAULT_PLATFORM_FEE_RATE_BPS: i128 = 100; // 1%
const DEFAULT_INSURANCE_FEE_RATE_BPS: i128 = 100; // 1%

// ثوابت الإيجار (State Expiration TTL)
...
// ===== دوال مساعدة لإدارة التخزين والإيجار (TTL Management) =====
...
impl AzmanToken {
    ...
    pub fn initialize(
        ...
        // تهيئة نسب الرسوم الافتراضية (1% منصة + 1% تأمين)
    ...
    // ==================== 5. معالجة الرسوم (متوافقة مع استدعاء v7.0) ====================
    ...
    // ==================== 6. توزيع رسوم الاقتراح الفاشل - للتوافق القديم ====================
